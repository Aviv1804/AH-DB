...
"SELECT", "FROM", "WHERE", "INSERT", "UPDATE", "DELETE", "CREATE", "ALTER", "DROP", "TABLE", "JOIN", "INNER", "LEFT", "RIGHT", "FULL", "GROUP BY", "HAVING", "ORDER BY", "DISTINCT", "UNION", "ALL", "AS", "AND", "OR", "NOT", "NULL", "IS", "LIKE", "IN", "BETWEEN", "EXISTS", "CASE", "WHEN", "THEN", "ELSE", "END", "LIMIT", "OFFSET", "SET", "VALUES", "RETURNING", "WITH", "CTE", "ROW_NUMBER", "PARTITION BY", "OVER", "INDEX", "VIEW", "TRIGGER", "PROCEDURE", "FUNCTION", "USER", "GRANT", "REVOKE", "COMMIT", "ROLLBACK", "TRANSACTION"
};
